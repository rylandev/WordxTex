namespace WordxTex
{
    partial class Ribbon : Microsoft.Office.Tools.Ribbon.RibbonBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            // DD_Complier
            // 
            ribbonDropDownItemImpl1.Label = "xeLaTex";
            ribbonDropDownItemImpl1.Tag = "complier=xelatex;cp_arg=-no-pdf%%BlankSpace-output-directory%%Equal%%OutDir%%Blan" +
    "kSpace%%InTexFile;ctarget=.xdv;ctip=.tex->.xdv";
            ribbonDropDownItemImpl2.Label = "LaTex";
    ...
    "l%%OutDir%%BlankSpace%%InTexFile;ctarget=.dvi;ctip=.tex->.dvi";
            ...
            // DD_Grapher
            // 
            ribbonDropDownItemImpl3.Label = "dvisvgm(vector)";
            ribbonDropDownItemImpl3.Tag = "grapher=dvisvgm;gr_arg=--output%%Equal%%OutImgFile%%BlankSpace-n%%BlankSpace%%InD" +
    "viFile;gtarget=.svg;gaccept=.dvi,.xdv;gtip=->.svg";
            ribbonDropDownItemImpl4.Label = "dvipng(0300dpi)";
            ribbonDropDownItemImpl4.Tag = resources.GetString("ribbonDropDownItemImpl4.Tag");
            ribbonDropDownItemImpl5.Label = "dvipng(0600dpi)";
            ...
            ribbonDropDownItemImpl7.Label = "dvipng(1200dpi)";
            ribbonDropDownItemImpl7.Tag = resources.GetString("ribbonDropDownItemImpl7.Tag");
            this.DD_Grapher.Items.Add(ribbonDropDownItemImpl3);
            ...
            ribbonDropDownItemImpl9.Label = "txfonts";
            ribbonDropDownItemImpl9.Tag = "\\usepackage{txfonts}";
            ribbonDropDownItemImpl10.Label = "fourier";
            ribbonDropDownItemImpl10.Tag = "\\usepackage{fourier}";
            ribbonDropDownItemImpl11.Label = "mathptmx";
            ribbonDropDownItemImpl11.Tag = "\\usepackage{mathptmx}";
            this.DD_Font_fx.Items.Add(ribbonDropDownItemImpl8);
            this.DD_Font_fx.Items.Add(ribbonDropDownItemImpl9);
            ...
            this.btn_insertTex.Label = "Insert LaTex";
            this.btn_insertTex.Name = "btn_insertTex";
            this.btn_insertTex.ShowImage = true;
            this.btn_insertTex.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.button2_Click);
            // 
            // btn_insMath
            // 
            ...
            this.btn_edit.Label = "Edit LaTex";
